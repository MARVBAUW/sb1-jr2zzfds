...
const solutionModules = [
  {
    ...
    description: "Gestion de projet, suivi budgétaire, réglementations",
    icon: HardHat,
    position: "top"
  },
  {
    title: "Maîtrise d'ouvrage",
    description: "Gestion de patrimoine, régulations, audits",
    icon: Building2,
    position: "left"
  },
  {
    title: "Entreprises et fournisseurs",
    description: "Appels d'offres, marketplace, supply chain",
    icon: Factory,
    position: "right"
  },
  {
    title: "Professionnels de l'immobilier",
    description: "Transactions, suivi des ventes, ciblage client",
    icon: HomeIcon,
    position: "bottom-left"
  },
  {
    title: "Clients particuliers",
    description: "Interface de suivi, paiements sécurisés",
    icon: Users2,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="relative">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 
              w-32 h-32 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 
              flex items-center justify-center z-20 shadow-xl shadow-blue-500/20">
              <div className="text-center text-white">
                <Cpu className="w-8 h-8 mx-auto mb-2" />
                <span className="text-sm font-medium">SaaS 360</span>
              </div>
            </div>
            ...
            <div className="absolute inset-0 z-10">
              <svg className="w-full h-full" viewBox="0 0 400 400">
                <path 
                  d="M200,200 L200,100 M200,200 L100,200 M200,200 L300,200 M200,200 L150,300 M200,200 L250,300"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-30">
              {solutionModules.map((module, index) => (
                ...
                >
                  <module.icon className="w-8 h-8 text-[rgb(var(--primary))] mb-4" />
