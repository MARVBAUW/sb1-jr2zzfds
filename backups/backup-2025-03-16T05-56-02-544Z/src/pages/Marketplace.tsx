...
import { Search, MapPin, Filter, Building2, Users2, Hammer, HomeIcon, Factory, Briefcase, Ruler, FileText, PaintBucket, Thermometer, ClipboardCheck, Wrench, Truck, HardHat } from 'lucide-react';
...
const professions = [
  ...
  { id: 'entreprise', name: 'Entreprise', icon: Factory },
  { id: 'particulier', name: 'Particulier', icon: Users2 },
];
