...
import { 
  ...
  ChevronLeft, ChevronRight, Heart, X, Share2, TrendingUp
} from 'lucide-react';
...
const mockProjects: Project[] = [
  {
    ...
    roi: {
      percentage: 15.5,
      duration: '5 ans',
      description: 'Rentabilité assurée par les économies d\'énergie et la valorisation immobilière'
    },
    images: [
  ...
  },
  {
    ...
    roi: {
      percentage: 22.8,
      duration: '3 ans',
      description: 'ROI rapide grâce aux économies d\'énergie substantielles'
    },
    images: [
  ...
  },
  {
    ...
    roi: {
      percentage: 18.2,
      duration: '7 ans',
      description: 'Rentabilité via la vente de crédits carbone et la valorisation immobilière'
    },
    images: [
  ...
  },
  {
    ...
    roi: {
      percentage: 12.5,
      duration: '4 ans',
      description: 'ROI optimisé par les aides à la rénovation et la revente'
    },
    images: [
  ...
  },
  {
    ...
    roi: {
      percentage: 25.5,
      duration: '6 ans',
      description: 'Forte rentabilité grâce à la production continue et aux circuits courts'
    },
    images: [
  ...
  {
    id: '6',
    name: 'Résidence Senior Tech',
    description: 'Complexe résidentiel intelligent adapté aux seniors intégrant des technologies d\'assistance et de monitoring santé.',
    location: 'Nice, France',
    budget: 4200000,
    duration: '30 mois',
    team: ['Philippe Martin - Architecte', 'Laura Klein - Experte e-santé', 'David Bernard - Domoticien'],
    impact: {
      environmental: 'Bâtiment à énergie positive avec récupération d\'eau',
      social: 'Maintien à domicile facilité et lien social renforcé',
      innovation: 'Système de télémédecine et domotique adaptative'
    },
    roi: {
      percentage: 16.8,
      duration: '8 ans',
      description: 'Rentabilité stable grâce aux services à forte valeur ajoutée'
    },
    images: [
      'https://images.unsplash.com/photo-1587560699334-cc4ff634909a?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1587560699334-bea93391dcef?auto=format&fit=crop&w=800&q=80'
    ],
    tags: ['Senior', 'Domotique', 'E-santé', 'Innovation']
  },
  {
    id: '7',
    name: 'Hub Logistique Vert',
    description: 'Centre logistique nouvelle génération alimenté par l\'énergie solaire avec flotte de véhicules électriques.',
    location: 'Marseille, France',
    budget: 5500000,
    duration: '28 mois',
    team: ['Nicolas Petit - Logisticien', 'Emma Roux - Ingénieure énergie', 'Thomas Blanc - Architecte industriel'],
    impact: {
      environmental: 'Réduction de 80% des émissions logistiques',
      social: 'Création de 50 emplois locaux qualifiés',
      innovation: 'Système automatisé de gestion des flux zéro émission'
    },
    roi: {
      percentage: 20.2,
      duration: '5 ans',
      description: 'ROI optimisé par les économies d\'échelle et l\'automatisation'
    },
    images: [
      'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1586528116493-5aa5c5f0b8b7?auto=format&fit=crop&w=800&q=80'
    ],
    tags: ['Logistique', 'Énergie', 'Automatisation', 'Durable']
  }
];
                ...
                <div className="absolute top-4 right-4">
                  <div className="px-3 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-500/30 
                    ...
                    <span className="text-sm font-medium text-emerald-400">
                      ROI {project.roi.percentage}% / {project.roi.duration}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                    <div className="flex items-center gap-2 mb-1">
                      <TrendingUp className="w-4 h-4 text-emerald-400" />
                      <h3 className="text-sm font-medium text-emerald-400">Rentabilité</h3>
                    </div>
                    <p className="text-xs text-gray-400">{project.roi.description}</p>
                  </div>
                </div>
              </div>
            </motion.div>
